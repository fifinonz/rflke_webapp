<div class="sidebar col-md-3 pull-right">
    <div class="sidebar-widget">
        ...
        <ul class="sidebar-list">
            ...
            <li><a style="font-size: 18px" href="<?php echo base_url();?>auth/create_user" title="">Create A Relay Account</a></li>
            <li><a style="font-size: 18px" href="<?php echo base_url();?>auth/login" title="">Log In</a></li>
        </ul>
    </div><!-- Category List -->
    <div class="sidebar-widget">
        <div class="sidebar-title">
