<div id="layerslider-container-fw">
    ...
    <div id="layerslider" style="width: 100%; height: 600px; margin: 0px auto; ">
        ...
        <div class="ls-slide" data-ls="transition3d:53; timeshift:-1000;">
            <img src="<?php echo base_url();?>assets/images/slider1.png" class="ls-bg" alt="Slide background">
        ...
        <div class="ls-slide" data-ls="transition3d:63;timeshift:-1000;">
            <img src="<?php echo base_url();?>assets/images/slider3.png" class="ls-bg" alt="Slide background">
...
<section class="block">
    <div class="container">
        <div class="row">
            <div class="fixed-bg " style="background:url(images/) no-repeat scroll 0 0 transparent; background-attachment:fixed; background-size:cover;"></div>
            <div class="col-md-12">
                <div class="sec-heading">
                    <h2><strong>Shujaa's </strong>Corner</h2>
                </div>
        ...
        <div id="redirect" class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="upcoming-event">
                    <img src="images/"" alt="" />
                    <h5>Relay For Life Kenya 2015</h5>
                    <ul>
                        <li><a href="#" title=""><i class="icon-twitter"></i>Twitter Updates</a></li>
                        <li><a href="#" title=""><i class="icon-calendar"></i>Oct 17 2015</a></li>
                        <li><a href="#" title=""><i class="icon-pencil"></i>Nyayo Stadium</a></li>
                    </ul>
                </div>
            </div>
        </div>
