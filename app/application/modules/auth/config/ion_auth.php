 ...
 */
$config['site_title']                 = "relayforlifekenya.org";       // Site Title, example.com
$config['admin_email']                = "ict@relayforlifekenya.org"; // Admin Email, admin@example.com
...
$config['remember_users']             = TRUE;                // Allow auth to be remembered and enable auto-login
$config['user_expire']                = 86500;               // How long to remember the user (seconds). Set to zero for no expiration
$config['user_extend_on_login']       = FALSE;               // Extend the auth cookies every time they auto-login
