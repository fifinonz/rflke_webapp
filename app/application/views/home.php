<div id="layerslider-container-fw">
	...
	<div id="layerslider" style="width: 100%; height: 530px; margin: 0px auto; ">
		...
		<div class="ls-slide" data-ls="transition3d:63;timeshift:-1000;">			
			...
			<p class="ls-l" style="top:290px; left:50%; line-height:30px; color:#FFF; font-family:noto sans; font-size:14px; text-align:center;" data-ls="durationin:1500; delayin:1500; easingin:easeOutQuart; fadein:false; easingout:easeInQuart; rotatexin:-90deg;">If one person can beat cancer, a whole NATION will DEFEAT IT</p>
		</div>
		...
		<div class="row">
			...
			<div class="services">
					...
					<div class="col-md-2">
						<div class="box">
							<i class="icon-tags"></i>
							<h4>What is Relay for Life?</h4>
						</div>
					</div>
					<div class="col-md-2">
						<div class="box">
							<i class="icon-tint"></i>
							<h4>Shujaa's Corner</h4>
						</div>
					</div>
					<div class="col-md-2">
						<div class="box">
...
<section class="block">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<div class="sec-heading">
					<h2><strong>Buy Relay For Kenya Merchandise</strong> Online</h2>
				</div>			
				<div class="shop">
					<ul class="slides">
						<li>
							<div class="item">
								<img src="images/"featured-product1.jpg" alt="" />
