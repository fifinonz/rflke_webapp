            ...
            <div class="left-content col-md-9">
                <div class="accordions">
                    <section class="block">
                        <div class="billing">
                         <div id="main">
    <div class="main-container login_form" id="login">
        ...
        echo "</div>";
        echo form_open('auth/registration_insert_member');

        echo"<strong>";
        echo lang('join_team_name_label');
        echo "</strong>";
        echo"<br/>";
        ...
        echo"<br/>";
        echo"<strong>";
        echo lang('join_team_tshirt_size');
        echo "</strong>";
        echo"<br/>";
        $options = array(
            'S'         => 'Small Shirt',
        ...
        echo"<br/>";
        echo"<strong>";
        echo lang('join_team_participant');
        echo "</strong>";
        echo"<br/>";
        $options = array(
        ...
        echo"<br/>";
        echo"<strong>";
        echo lang('join_team_mpesa_code');
        echo "</strong>";
//        $data = array(
//            'name'        => 'mpesa_code',
//            'id'          => 'mpesa_code',
//        );
        echo form_input('mpesa_code');
        echo"<br/>";
        echo"<br/>";
